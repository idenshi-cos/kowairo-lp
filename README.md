...
2026年9月の統合で、青緑のLPにGitHub最新版の紹介動画を組み込みました。動画は `public/demo/kowairo_demo_customer_v11.mp4`、医師向けページは `/doctor` です。公開トップページから詳細な画面説明とマニュアルへのリンクを外し、会社情報を折りたたんでいます。
