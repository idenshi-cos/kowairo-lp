const steps = [
  {
    title: "ヒアリング・デモ",
    description: "診療体制や連携先の状況をヒアリングし、実際のデモをご覧いただきます。",
    duration: "約30分",
  },
  {
    title: "契約",
    description: "常勤・非常勤の人数に合わせた内容でご提案。納得いただいてから契約いただけます。",
    duration: "最短1日",
  },
  {
    title: "即日導入",
    description: "導入設定はシンプル。既存システムはそのままで、すぐに全医師が使い始められます。",
    duration: "当日〜",
  },
  {
    title: "運用サポート",
    description: "導入後もサポートチームが伴走。連携先ごとの共有フォーマットの調整もお手伝いします。",
    duration: "継続的に",
  },
];

export default function DoctorFlowSection() {
  return (
