...
const steps = [
  {
    step: 1,
    title: "診察中の会話を記録",
    description: "訪問診療中の会話やメモを入力。<br/>いつも通りの診察の中で大丈夫です。",
  },
  {
    step: 2,
    title: "AIが整理・要約",
    description: "診療記録に必要な情報、<br/>状態変化のポイントをAIが整理します。",
  },
  {
    step: 3,
    title: "記録・指示書・共有文を作成",
    description: "診療記録、訪問看護指示書、<br/>多職種向け共有文に活用できます。",
  },
  {
    step: 4,
    title: "チームで共有・活用",
    description: "ケアマネ・訪問看護師・薬剤師へ、<br/>必要な情報がそのまま届きます。",
  },
];
      ...
      <div className="container-wide">
        ...
        >
          ...
          <h2 className="section-title">
            訪問診療の会話が、
            <br />
            <span className="text-teal">記録・指示書・共有</span>につながる
          </h2>
        ...
        >
          ...
          <div className="text-body text-sm max-w-2xl space-y-1">
            ...
            <p>kowairoが生成した記録・指示書・共有文をコピー＆ペーストで転記するだけ。導入のハードルを極限まで下げました。</p>
          </div>
        </div>
      </div>
    </section>
