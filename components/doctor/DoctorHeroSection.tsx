    ...
    <section className="relative min-h-screen flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center w-full lg:w-[55%] px-8 md:px-16 lg:px-20 pt-24 pb-16 bg-cream">
        ...
        <div className={`flex flex-col sm:flex-row gap-4 mb-12 ${item()}`} style={style(720)}>
          ...
          <a href="#collaboration" className="btn-secondary gap-2">
            <PlayCircle size={18} />
            多職種連携の仕組みを見る
          </a>
        </div>
        ...
        <div className={`flex flex-wrap gap-8 ${item()}`} style={style(880)}>
          <div>
            <p className="text-4xl md:text-5xl font-black text-teal leading-none">診療記録</p>
            <p className="text-body text-sm mt-1">下書き作成を支援</p>
          </div>
          <div className="w-px bg-gray-200" />
          <div>
            <p className="text-4xl md:text-5xl font-black text-coral leading-none">多職種</p>
            <p className="text-body text-sm mt-1">連携文をワンタップ共有</p>
          </div>
          <div className="w-px bg-gray-200" />
          <div>
            <p className="text-4xl md:text-5xl font-black text-mustard leading-none">即日</p>
      ...
      <div className="lg:hidden w-full bg-navy relative overflow-hidden" style={{ height: 320 }}>
        {[
          ...
          >
            <Image src={photo.src} alt="在宅医療の現場" fill className="object-cover" />
          </div>
        ))}
